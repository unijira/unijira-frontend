...
export class HttpService {
  ...
  constructor(
    ...
    if (localStorage.getItem('token')) {
      this.opt.headers = this.opt.headers.set(
        'Authorization',
  ...
  public get<T>(
    ...
    console.log(`${environment.baseURL}${api}`);
    return this.handleResponse<T>(
      this.http.get<T>(`${environment.baseURL}${api}`, {
        ...this.opt,
        ...options,
        observe: 'response',
        params,
  ...
  public post<T>(
    ...
    console.log(`${environment.baseURL}${api}`);
    return this.handleResponse<T>(
      this.http.post<T>(`${environment.baseURL}${api}`, body ?? {}, {
        ...this.opt,
        ...options,
        observe: 'response',
        params,
  ...
  public delete<T>(
    ...
    return this.handleResponse<T>(
      this.http.delete<T>(`${environment.baseURL}${api}`, {
        ...this.opt,
        ...options,
        observe: 'response',
        params,
