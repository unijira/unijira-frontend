...
export class BacklogPage implements OnInit {
  ...
  constructor(
    ...
    this.backlog.tasks[1].assignedTo = [];
    this.backlog.tasks[1].assignedTo.push(new User());
    this.backlog.tasks[2].assignedTo = [];
    this.backlog.tasks[2].assignedTo.push(new User());
